        ...
        <?php if ($this->session->flashdata('success')) { ?>
            ...
            <!-- <div class="box-body"> -->
                  <div class="col-md-10 col-sm-12">
                    ...
                    <div class="ft-size" style="text-align: center; font-weight: bold; color:#c4171d !important;">University Application Status</div>
                    <div class="box box-widget widget-user-2">
                      ...
                      <div class="box-footer no-padding pad">
                        ...
                        <div style="margin-bottom:20px;"><a href="<?php echo base_url('dashboard'); ?>" class="btn btn-info pull-left">Go to Dashboard</a> <a href="<?php echo base_url('slogout'); ?>" class="btn btn-success pull-right">Sign Out</a></div>
                ...
                <?php foreach($university as $key => $data){   ?>
                              ...
                              <div class="box box-warning box-solid collapsed-box">
                                ...
                                <div class="box-body" style="display: none; overflow: scroll; background-color:#e5e5e5;">
                                  ...
                                  <p style="font-size: 16px;"> Student can notify us for any change in status any of the fields                                    
                        ...
                        ?>
                                                                                    ...
                                                                                    <?php 
                          if ($data['Filename']!='false' && $data['Filename']!='') {
                        ?>
                        ...
                        if ($data['decision']=='Admit') {
                            ?>
                                                                                                  ...
                                                                                                  <b>  <?php echo  ucwords($data['decision']); ?></b> <br/>
                                                                                          <?php if($data['admit_reject_letter']!='' && $data['admit_reject_letter']!='null'){ ?>
                                                                                                    <a href="<?php echo base_url().'admit_reject_letter/'.$data['admit_reject_letter']; ?>" class="btn btn-success" target="_blank">Admit Letter</a>
                                                                                                    <?php } ?>
                        <?php } elseif($data['decision']=='Rejected') {
                            ?> 
                                                                                                        <i class="fa fa-times-circle" style="color:red"></i>
                                                                                                       <b>  <?php echo ucwords($data['decision']);?> </b> <br/>
                                                                                                        <?php if($data['admit_reject_letter']!='' && $data['admit_reject_letter']!='null'){ ?>
                                                                                                            <a href="<?php echo base_url().'admit_reject_letter/'.$data['admit_reject_letter']; ?>" class="btn btn-danger" target="_blank">Rejection Letter</a>

                                                                                                      <?php } ?>
                                                                                                        

                 <?php } elseif($data['decision']=='Insufficient Documents') {
                            ?>
                                                                                                            <i class="fa fa-exclamation-circle" style="color:orange"></i>
