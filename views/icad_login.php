    ...
    <div class="site" id="page">
        ...
        <section class="hero-section hero-section--image clearfix clip">
            ...
            <!-- <div class="container"> -->
                 ...
                 <!--    <div class="stud_assist"><h3 class="stud_assist" style="text-align: center; font-weight: bold; padding-bottom: 8px;padding-top: 8px;"><i style="color: #c4171d;">#</i><i style="color: #2f3562;">Student</i> <i style="color: #c4171d;">Section</i></h3></div> -->
                <div class="row">
                    ...
                    <div class="title-01 title-01--11 text-center">
                        ...
                        <div class="title__description">
                            <div class="login-form">
                                <?php echo form_open_multipart('check_login');?>
                                    <h2 class="text-center" style="color: #fff;">ICAD Login</h2>
       ...
       <footer style="background-color:#5d6d7e; color: white;">
                            <!-- <div class="container my-auto"> -->
                                <div class="copyright text-center my-auto" >
                                    <span style="font-weight: bold; font-size: 16px;">Copyright © Design & Developed By Shah-Overseas 2020-21</span>
                                </div>
                          <!--   </div> -->
                        </footer>
        <!-- JS -->
