                  ...
                  <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="hidden" name="lor1_prev" value="<?php echo ucwords($data['lor1_status']);?>">
                      </div>
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      ...
                      <input type="hidden" name="lor2_prev" value="<?php echo ucwords($data['lor2_status']);?>">
                    </div>
                  </div>
                 <div class="row">
                            <div class="col-md-4">
                            ...
                            <input type="hidden" name="lor3_prev" value="<?php echo ucwords($data['lor3_status']);?>">
                          </div>
                                <hr>
                          <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="hidden" name="gre_prev_off" value="<?php echo ucwords($data['et_ostatus']);?>">
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                            ...
                            <div class="col-md-3">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                 ...
                                 <input type="hidden" name="toefl_prev_off" value="<?php echo ucwords($data['ep_ostatus']);?>">
                              </div>
                               <div class="col-md-3">
                                  <div class="form-group">
                                    <label>Unofficial Score</label>
                          ...
                          <div class="row">
                               <div class="col-md-3">
                                  ...
                                  <input type="hidden" name="trans_prev_off" value="<?php echo ucwords($data['tofficial_status']);?>">
                                </div>
                                <div class="col-md-3">
                                  <div class="form-group">
                     ...
                     <h4 class="title">Application Fees</h4>
                          ...
                          <div class="row">
                              <div class="col-md-4">
                                ...
                                <input type="hidden" name="prev_fees_status" value="<?php echo ucwords($data['fees_status']);?>">
                              </div>
                              <div class="col-md-4">
                                <div class="form-group">
                                  <label>Paid By</label>
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                ...
                                <input type="hidden" name="prev_decision" value="<?php echo ucwords($data['decision']);?>">
                              </div>
                              <div id="admit_rejects">
                                <div class="col-md-3" style="background-color:  #16a085; color:white;">
                                  <div class="form-group">
                                    <label>Upload Admit/Reject Letter</label>
                                     <input type="file" class="form-control" name="admit_reject" value="$Filename" >
                                     <input type="hidden" name="admit_letter" value="<?php echo $data['admit_reject_letter']?>">
                                   </div>
                                </div>
                                <?php if($data['admit_reject_letter']!='null' && $data['admit_reject_letter']!=''){ ?>
                                  <div class="col-md-3">
                                    <a href="<?php echo base_url('admit_reject_letter/'.$data['admit_reject_letter'])?>" class="btn btn-success" target="_blank">View Admit/Reject Letter</a>
                                  </div>
                              <?php } ?>
                              </div>
                          </div>
                      ...
                      <hr>
                         <div class="row">
                          <div class="col-md-6">
                            ...
                            <input type="hidden" name="prev_i20" value="<?php echo ucwords($data['i20_status']);?>">
                          </div>
                          <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <input type="text" name="fileget" value="<?php echo $data['Filename']; ?>">
                                <?php
                                  }
                                ?>
                              </div>
...
$(document).ready(function(){
    $("#decision").change(function(){
        $(this).find("option:selected").each(function(){
            ...
            if(optionValue=="Admit" || optionValue=="Rejected"){                
                $("#admit_rejects").show();
            } else{
                $("#admit_rejects").hide();
            }
