          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                 ...
                 <?php if(empty($resume)): ?>
                      ...
                      <?php else: ?>
                        <div class="col-sm-12">
                          <a href="<?php echo site_url('create_resume') ?>" class="btn btn-warning">Edit Resume</a>
                          <a href="<?php echo site_url('create_resume_pdf') ?>" class="btn btn-primary pull-right" target="_blank">Create Pdf</a>
                          <a href="<?php echo site_url('to_word') ?>" class="btn btn-primary pull-right" style="margin-right: 20px;">Create Word</a>
                        </div>
